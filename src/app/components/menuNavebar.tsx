      ...
      <Image src={'/images/magnifyingGlass.png'} alt='photo' width={24} height={24} ></Image>
        ...
        <div className=' w-[1920] h-[410px] mt-8'>
             ...
             <div className='w-[219px] h-[104px] absolute top-[198px] left-[850px]'>
                <h2 className='w-[225px] h-[56px] font-bold text-[48px] size-[48px] leading-[56px]'>Our Menu</h2>
                 <div className='flex gap-4 ml-8'> 
                    ...
                    <p className='w-[56px] h-[28px] font-semibold  size-[20px] leading-[28px] text-[#FF9F0D]'>Menu</p>
                 </div> 
