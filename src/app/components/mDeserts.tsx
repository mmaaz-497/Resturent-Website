    ...
    <div className="bg-gray-200 text-black px-6 md:px-16 py-10">
      <div className="max-w-7xl mx-auto flex flex-col lg:flex-row gap-10">
        <div className="w-full lg:w-[450px]">
          <Image src="/images/desertPic.png" alt="Dessert Image" width={448} height={626} className="w-full rounded-lg object-cover" />
        </div>
        <div className="flex-1">
          <h2 className="text-4xl font-bold">Desserts</h2>
